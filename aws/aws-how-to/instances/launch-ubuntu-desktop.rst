...
Select a region closest to you. For exapmple, if you're in the ``UK EU-West-2`` would be a good option. Cick:guilabel:`Continue to Launch Through EC2 Instance`.
