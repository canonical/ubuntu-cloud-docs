...
html_context = {
    ...
    'discourse': 'https://discourse.ubuntu.com/c/project/gcp/',
...
html_baseurl = f"https://ubuntu.com/gcp/docs/"
ogp_site_url = f"https://ubuntu.com/gcp/docs/"

# Adds custom JavaScript files, located remotely or in 'html_static_path'.
html_js_files = ['js/bundle.js', 'js/overwrite_links_gcp.js']
...
llms_txt_description = textwrap.dedent(
    """\
    This is the documentation for Ubuntu images available on Google Cloud.
    """
)
