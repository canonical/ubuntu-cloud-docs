...
html_context = {
    ...
    # TODO: Change to the folder that contains the documentation 
    # (usually "/" or "/docs/")
...
redirects = {
    ...
    "oci/oci-how-to/enable-pro-services/":
        "https://documentation.ubuntu.com/pro-client/en/latest/howtoguides/enable_in_dockerfile/"
}
