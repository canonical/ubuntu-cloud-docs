...
Chrony configuration modified (may occur)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Canonical modifies the file ``/etc/chrony/chrony.conf`` in Azure images. As a result, you may see a prompt during upgrade notifying you about the availability of a newer version of the file. You'll be asked if you want to keep the existing modified version, use the default one from the new upgrade, or take some other action.

.. image:: upgrade-ubuntu-lts-release-images/4_chrony_modified_config.png
   :align: center
...
Canonical modifies the file ``/etc/ssh/sshd_config`` in Azure images. As a result, you may see a prompt during upgrade notifying you about the availability of a newer version of the file. You'll be asked if you want to keep the existing modified version, use the default one from the new upgrade, or take some other action.

.. image:: upgrade-ubuntu-lts-release-images/5_sshd_modified_config.png
   :align: center


useradd configuration modified (may occur)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Canonical modifies the file ``/etc/default/useradd`` in some Azure images. As a result, you may see a prompt during upgrade notifying you about the availability of a newer version of the file. You'll be asked if you want to keep the existing modified version, use the default one from the new upgrade, or take some other action.

.. image:: upgrade-ubuntu-lts-release-images/6_useradd_modified_config.png
   :align: center
...
.. image:: upgrade-ubuntu-lts-release-images/7_remove_obsolete.png
   :align: center
...
.. image:: upgrade-ubuntu-lts-release-images/8_finish_upgrade.png
   :align: center
