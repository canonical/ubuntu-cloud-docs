...
`Expanded Security Maintenance (ESM) <https://ubuntu.com/security/esm>`_ and `FIPS <https://ubuntu.com/security/fips>`_. For instructions, see :ref:`Create an Ubuntu FIPS Docker image <how-to-fips-ubuntu-container>`.
