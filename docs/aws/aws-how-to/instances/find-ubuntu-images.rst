      ...
      .. tabs::
         .. tab:: For EC2
            ...
            .. code-block::
               ...
               ubuntu/images/$VIRT_TYPE-$VOL_TYPE/ubuntu-$RELEASE-$ARCH-$VARIANT-*
            ...
            * VOL_TYPE: `ssd-gp3` (for >=23.10), `ssd` (for <=23.04), or `instance-store`
            ...
            In place of a wildcard, the serial number given to an image can also be used (e.g., 20210222):
            
            .. code-block::

               ubuntu/images/$VIRT_TYPE-$VOL_TYPE/ubuntu-$RELEASE-$ARCH-$VARIANT-$SERIAL
         ...
         .. tab:: For EKS
            ...
            * K8S_VERSION: one of the supported EKS versions (e.g. `1.31`)
            * ARCH: `amd64` or `arm64`
            * VOL_TYPE: `ssd` (for <= Jammy) and `ssd-gp3` (for >= Noble)
