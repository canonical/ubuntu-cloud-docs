...
:ref:`Ubuntu Pro <pro>` extends Ubuntu LTS’ standard 5 years of security maintenance to 10 years, with an additional 5 years available through the Legacy add-on. It also expands security coverage beyond the main repository to more than 40,000 packages in the Universe repository.
